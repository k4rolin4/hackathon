...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseAdminProductsService, { provide: GETS_ALL_PRODUCT_DTO, useExisting: FirebaseAdminProductsService }, { provide: ADDS_PRODUCT_DTO, useExisting: FirebaseAdminProductsService }, { provide: REMOVES_PRODUCT_DTO, useExisting: FirebaseAdminProductsService }],
  	exports: [] })
