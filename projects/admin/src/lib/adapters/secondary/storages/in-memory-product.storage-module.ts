...
@NgModule({ imports: [],
  	declarations: [],
  	providers: [InMemoryProductStorage, { provide: SETS_STATE_PRODUCT_CONTEXT, useExisting: InMemoryProductStorage }, { provide: SELECTS_PRODUCT_CONTEXT, useExisting: InMemoryProductStorage }, { provide: PATCHES_PRODUCT_CONTEXT, useExisting: InMemoryProductStorage }],
  	exports: [] })
